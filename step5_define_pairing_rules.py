...
#------------------ congruent paring: wine nonaroma is the same as or stronger than food nonaroma, to amplify common flaor -------------------
...
#------------------- contrasting paring: wine nonaroma balances food strong nonaromas -------------------------
...
def congruent_or_contrasting_pairing(df, food_nonaromas):
